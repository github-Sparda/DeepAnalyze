...
class PlanStore:
    def __init__(self, workspace_dir: Path) -> None:
        ...
        self.plans_dir = ensure_dir(self.workspace_dir / "plans")
    ...
    def _artifact_plan_dir(self, plan_id: str) -> Path:
        return ensure_dir(self.workspace_dir / "artifacts" / plan_id / "plan")
...
class ArtifactRegistry:
    def __init__(self, workspace_dir: Path) -> None:
        self.workspace_dir = Path(workspace_dir)
        self.artifacts_dir = ensure_dir(self.workspace_dir / "artifacts")
