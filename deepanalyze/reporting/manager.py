...
class ReportManager:
    ...
    def create_report(
        ...
        try:
            ...
            # 创建报告目录
            report_dir = self.workspace_base / session_id / "reports" / report_id
    ...
    def list_reports(self, session_id: str) -> List[ReportMetadata]:
        """列出会话中的所有报告"""
        try:
            reports_dir = self.workspace_base / session_id / "reports"
    ...
    def export_report(
        ...
        try:
            ...
            if output_path is None:
                output_dir = self.workspace_base / session_id / "exports"
...
# 便捷函数
def get_report_manager(workspace_base: str = "workspace") -> ReportManager:
    """获取报告管理器实例"""
    return ReportManager(workspace_base)
