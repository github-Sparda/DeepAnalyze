...
class RStatisticalPackagesTool(ToolInterface):
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        # 根据分析类型生成相应的R代码
        r_code, return_vars = self._generate_analysis_code(analysis_type, formula, parameters)
    ...
    def _generate_analysis_code(self, analysis_type: str, formula: Optional[str], 
