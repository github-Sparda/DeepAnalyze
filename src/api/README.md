...
All addresses/ports below are configured in `src/api/config.py`. If you change them there, keep the data/exampless in sync.
...
```bash
cd data/examples
python data/examplesRequest.py          #  requests data/examples
...
The `data/examples/` directory contains comprehensive data/exampless:

- `data/examples.py` - Simple requests data/examples
- `data/examplesOpenAI.py` - OpenAI library data/examples
