...
class ExecutionMonitor:
    def __init__(self, data_sessions_active_dir: Path, plan_id: str) -> None:
        self.data_sessions_active_dir = data_sessions_active_dir
        self.plan_id = plan_id
        self.log_dir = ensure_dir(self.data_sessions_active_dir / "outputs_logs" / "execution")
...
class CodeExecutionOrchestrator:
    def __init__(self, llm: Any, config: dict[str, Any], data_sessions_active_dir: Path, plan_id: str) -> None:
        self.llm = llm
        self.config = config
        self.data_sessions_active_dir = data_sessions_active_dir
        self.plan_id = plan_id
        ...
        self.legacy_code_dir = ensure_dir(self.data_sessions_active_dir / "code")
    ...
    def _write_code(self, entry: dict[str, Any]) -> dict[str, Any]:
        ...
        record_artifact(self.data_sessions_active_dir, path, "code", "generate_code")
    ...
    def execute(
        ...
        legacy_results_dir = ensure_dir(self.data_sessions_active_dir / "result")
        recorded: list[dict[str, Any]] = []
        ...
        def _run(step: dict[str, Any]) -> dict[str, Any]:
            ...
            record_artifact(self.data_sessions_active_dir, result_path, "result", "execute_steps")
